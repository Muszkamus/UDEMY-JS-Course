...
# <center> Section 13: Advanced DOM and Events [Project]
...
# <center>**Section 16 - Asynchronous JS** </center>

---

---

# 256. **synchronous JavaScript, AJAX and APIs**

---

- Most code is synchrinous
...
- **AJAX** Asynchronous Javascript And XML: Allows us to communinicate with remote web servers in an asynchronous way. With AJAX calls, we can request data from web servers dynamically.
...
1. **DNS Lookup**
   ...
   - Translates the website name (e.g., google.com) into an IP address.

2. **TCP/IP Connection**

   - A connection is made between your device and the web server.

3. **HTTP Request**

   - Your browser asks the server for the webpage.
...
5. **Loading & Processing**
   ...
   - It is scanned for assets (CSS, JS, images).
   - Each asset is requested and loaded.
...
- **Promise:** An object that is used as a placeholder for the future result of an asynchronous operation > Container for a future value (resposne from AJAX call)
