...
const calcAverage = (scorePoints) => {
    const averageDolphins = averagePoints(scorePoints)
    const averageKoalas = averagePoints(scorePoints)
    const scores = `Dolphins average is ${averageDolphins}, Koalas average is ${averageKoalas}`
    return scores
}


const DolphinsPoints = console.log(calcAverage(30));
const KoalasPoints = console.log(calcAverage(90));
